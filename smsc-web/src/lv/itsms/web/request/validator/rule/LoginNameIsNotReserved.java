...
public class LoginNameIsNotReserved implements Rule {

	Repository repository;

	String customerUserName;

	public LoginNameIsNotReserved(Repository repository, String customerUserName) {
		this.repository = repository;
		this.customerUserName = customerUserName;
	}

	public LoginNameIsNotReserved(Repository repository) {
		this.repository = repository;
	}
